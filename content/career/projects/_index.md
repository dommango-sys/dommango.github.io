...
| Project | Role | Impact |
|---------|------|--------|
| [Consent Order Remediation](citi-consent-order.md) | Citi | $7.1B portfolio governance |
| [Strategic Investment Data Architecture](citi-data-architecture.md) | Citi | $1.1B visibility |
...
- MRA lifecycle management

### Data & Analytics
- Strategic investment data architecture
- PM Core Metrics framework
- CEO/Board dashboards

### Process Optimization
- Six Sigma trade processing
- VBA automation
- EUC streamlining
